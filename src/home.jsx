    ...
    <>
      <div className="flex flex-wrap sm:gap-5 justify-evenly mt-12 ">
        <div >
          ...
          <p className="text-gray-300 mt-5">React js developer turning ideas into polished cross-<br />
        ...
        <div className="bg-[#131d2e] mt-5 border-t-[1px] border-[#60a5fa]  h-96 w-80 rounded-2xl">
          ...
          <div className="h-12 w-72 pl-9 flex items-center gap-2 ml-4 mt-1 text-white hover:bg-[#1a2535] hover:border-[1px] hover:border-[#bfdbfe] hover:rounded-xl font-bold text-sm" > <img className="h-5 w-5" src="https://img.icons8.com/?size=100&id=69537&format=png&color=228BE6"></img>    <span>Nodejs,Express</span></div>
